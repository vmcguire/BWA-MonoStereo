...
> Do all work in the monorepo: **`~/Developer/bwa-fx-ecosystem/BWA-MonoStereo/`**
...
```bash
git subtree push --prefix=BWA-MonoStereo git@github.com:vmcguire/BWA-MonoStereo.git main
```

Then cut a GitHub Release in this mirror and attach the notarized `BWA-MonoStereo.vst3`.
