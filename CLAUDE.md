# BWA-MonoStereo — read before doing anything

> ✅ **This is the CANONICAL home for BWA-MonoStereo.** All serious DSP, IP, and
> process for this plugin live **here**, in `~/Developer/BWA-MonoStereo/`. Author here — always.
>
...
> changes. This file deliberately holds only what is specific to BWA-MonoStereo; every
...
4. **`docs/MARKET-PAIN-AND-ATTACKS.md`** — the row for **BWA-MonoStereo**; internalize the pain + attack before any DSP.
...
Then cut a GitHub Release here (`vmcguire/BWA-MonoStereo`) and attach the notarized `BWA-MonoStereo.vst3`.
